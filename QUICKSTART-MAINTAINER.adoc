...
// Replace sanctify-php, sanctify-php, {{DEPS}} with actuals
= sanctify-php — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining sanctify-php for
...
| `$PREFIX/share/sanctify-php/`
| Data files, assets

| `$PREFIX/share/doc/sanctify-php/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/sanctify-php/config.toml`

Fallback: `$HOME/.config/sanctify-php/config.toml`
...
Or via OPSM: `opsm update sanctify-php`
...
[source,bash]
----
just install --prefix=/opt/sanctify-php-instance1 --config=/etc/sanctify-php/instance1.toml
just install --prefix=/opt/sanctify-php-instance2 --config=/etc/sanctify-php/instance2.toml
----
...
* Upstream: https://github.com/hyperpolymath/sanctify-php/issues
