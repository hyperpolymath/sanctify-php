...
// Replace sanctify-php, Sanctify Php — See README.adoc for details., just run, Sanctify Php started successfully. with actuals
= sanctify-php — Quick Start for Users
:toc:
:toclevels: 2

== What is sanctify-php?

Sanctify Php — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./sanctify-php-portable
----
...
[source]
----
Sanctify Php started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/sanctify-php/wiki
