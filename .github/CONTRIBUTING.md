...
git clone <https://github.com/hyperpolymath/sanctify-php.git> cd
sanctify-php
...
toolbox create sanctify-php-dev toolbox enter sanctify-php-dev \#
...
sanctify-php/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/sanctify-php/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/sanctify-php/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/sanctify-php/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/sanctify-php/labels/perimeter-3) — Community sandbox scope
