...
* Use link:ROADMAP.adoc[ROADMAP.adoc], link:TEST-NEEDS.md[TEST-NEEDS.md], and link:PROOF-NEEDS.md[PROOF-NEEDS.md] as the primary readiness documents.
...
[NOTE]
====
This README describes the intended capability surface of the tool. It should not be read as proof that every analysis and transform is already trustworthy enough for production security decisions.
====
